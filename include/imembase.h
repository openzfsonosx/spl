...
#include <unistd.h>
//#include <pthread.h>
#define IMUTEX_TYPE         kmutex_t
#define IMUTEX_INIT(m)      mutex_init((kmutex_t *)(m), "imembase", MUTEX_DEFAULT, NULL)
//#define IMUTEX_DESTROY(m)   mutex_destroy((kmutex_t *)(m))
#define IMUTEX_LOCK(m)      mutex_enter((kmutex_t *)(m))
#define IMUTEX_UNLOCK(m)    mutex_exit((kmutex_t *)(m))
#endif
#endif
