...
void bmalloc_init()
{
    ...
    allocation_counters = osif_malloc(ALLOCATOR_SLICE_SIZES[NUM_ALLOCATORS - 1] * sizeof(sa_size_t));
    osif_zero_memory(allocation_counters, ALLOCATOR_SLICE_SIZES[NUM_ALLOCATORS - 1] * sizeof(sa_size_t));
#endif
}
